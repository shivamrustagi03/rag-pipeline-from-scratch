# This file is basically used to load data from various sources like PDFs, text files, etc.
# And prepare it for further processing like chunking, embedding, etc.
